...
const features: Feature[] = [
  ...
  { label: 'Calculadoras productivas',        free: 'Manual',      pro: 'Completa' },
  { label: 'Historial de cálculos',           free: false,         pro: true },
  { label: 'Cálculos con datos del campo',    free: false,         pro: true },
  { label: 'Crear trabajos desde cálculos',   free: false,         pro: true },
  ...
  { label: 'Galpones avícolas',               free: 'Hasta 1',     pro: 'Ilimitados' },
  { label: 'Registros avícolas',              free: 'Hasta 30',    pro: 'Ilimitados' },
  { label: 'Registros de ordeñe',             free: 'Hasta 30',    pro: 'Ilimitados' },
  { label: 'Cultivos frutihortícolas',        free: 'Hasta 3',     pro: 'Ilimitados' },
  { label: 'Cosechas por cultivo',            free: 'Hasta 10',    pro: 'Ilimitadas' },
  { label: 'Cuadros de yerba',                free: 'Hasta 1',     pro: 'Ilimitados' },
  { label: 'Cosechas por cuadro de yerba',    free: 'Hasta 10',    pro: 'Ilimitadas' },
