...
const navItems: NavItem[] = [
  ...
  { to: (id) => `/org/${id}/frutihorticultura`, label: 'Frutihorticultura', icon: Apple, modulo: 'Cultivos' },
  { to: (id) => `/org/${id}/yerba`, label: 'Yerba mate', icon: Leaf, modulo: 'Cultivos' },
  ...
  { to: (id) => `/org/${id}/tambo`, label: 'Tambo y lácteos', icon: Milk, modulo: 'GanaderÃ­a' },
  { to: (id) => `/org/${id}/avicola`, label: 'Avícola', icon: Bird, modulo: 'GanaderÃ­a' },
